...
import { clientConfig, getWhatsAppLink } from "@/config/client";

export const metadata: Metadata = {
  title: clientConfig.intakePage.meta.title,
  description: clientConfig.intakePage.meta.description,
  alternates: {
    canonical: "/your-business",
  },
};

export default function YourBusinessPage() {
  const { businessName, contact, intakePage, whatsapp } = clientConfig;
              ...
              <div className="rounded-[calc(var(--radius-section)*0.78)] border border-(--panel-border) bg-(--page-background) p-5 sm:p-6">
                ...
                <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <p className="text-sm text-(--text-muted)">
                    {businessName} reviews each submission and follows up as soon as possible.
                  </p>
                </div>
              </div>
            </FadeIn>
